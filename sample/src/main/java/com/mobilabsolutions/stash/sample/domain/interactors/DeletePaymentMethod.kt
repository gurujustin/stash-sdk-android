...
) : Interactor<DeletePaymentMethod.Params>() {
    override val scope: CoroutineScope = processScope + dispatchers.io

    override suspend fun doWork(params: Params) {
        paymentMethodRepository.deletePaymentMethod(paymentMethod = params.paymentMethod)
    }

    data class Params(val paymentMethod: PaymentMethod)
}